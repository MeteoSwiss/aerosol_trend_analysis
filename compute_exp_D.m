...
if ~isempty(namesBs)
    ...
    elseif length(namesBs)== 6
        Cs(1,:)=contains(namesBsG,'0_')& ~contains(namesBsG,'dry') & ~contains(namesBsG,'Q');
        Cs(2,:)=contains(namesBsG,'1_')& ~contains(namesBsG,'dry') & ~contains(namesBsG,'Q');
        ...
        if ~isempty(namesBbs)
            Cbs(1,:)=contains(namesBbsG,'0_');
            Cbs(2,:)=contains(namesBbsG,'1_');
            for i=1:2
                namesBbsx=namesBbs(Cbs(i,:));
                Bb=namesBbsx(startsWith(namesBbbsx,'BbsB'));
                Bg=namesBbsx(startsWith(namesBsx,'BbsG'));
