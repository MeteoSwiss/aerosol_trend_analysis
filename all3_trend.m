...
Tresult_LMSlog2=trend_LMS_deseasonMed_D(data, param,inst, station, 'log',varargin{:});

Tresult_LMSlin=trend_LMS_D(data, param,inst, station, 'lin',varargin{:});
Tresult_LMSlin2=trend_LMS_deseasonMed_D(data, param,inst, station, 'lin',varargin{:});
